...
export const enUS = {
  ...
  'apiKey.upstream.col': 'Upstream',
  'apiKey.upstream.default': 'Default',
  'apiKey.upstream.edit': 'Configure',
  'apiKey.upstream.add': 'Add Upstream Binding',
  'apiKey.upstream.caption': 'Per-user Upstream Binding (BYOK)',
  'apiKey.upstream.userId': 'User ID',
  'apiKey.upstream.userId.extra': 'Kernel-assigned user_id (usr-*); matching requests are forwarded to the upstream below',
  'apiKey.upstream.url': 'Upstream URL',
  'apiKey.upstream.url.extra': 'Model keys are passed through from the developer client; save empty to unbind and fall back to the default upstream',
  'apiKey.upstream.url.invalid': 'Invalid upstream URL',
  'apiKey.upstream.save': 'Save',
  ...
  'systemConfig.desc': 'Developers all connect through the official endpoint (same flow as Tencent mem) and default to the global upstream. For BYOK, an admin binds a custom upstream per user_id on the "API Keys" page; model keys are passed through from the developer client. Set the global Proxy upstream in the ⚙ settings dialog, "Proxy Upstream" tab.',
  'systemConfig.readonly.upstream': 'Current global upstream (read-only; edit via the settings dialog)',
