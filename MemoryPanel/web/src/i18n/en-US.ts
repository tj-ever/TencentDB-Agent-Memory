...
export const enUS = {
  ...
  'channels.field.model': 'Model',
  'channels.field.proxy': 'Proxy URL',
  'channels.field.userKey': 'Mem user_key',
  ...
  'channels.help.model': 'Upstream model name forwarded via MemoryProxy to the real LLM. Must match PROXY_UPSTREAM_MODEL in .env or the request fails.',
  'channels.help.proxy': 'MemoryProxy URL; claude requests route through it for memory/knowledge injection. Leave empty to fall back to http://tdai-proxy:8096. Do NOT point directly at a raw LLM endpoint or you lose memory injection.',
  'channels.help.userKey': 'Mem account user_key; the proxy validates it via auth/verify (NOT an LLM key). Obtained from the Mem user page. An invalid one returns invalid_user_key.',
