...
export const enUS = {
  ...
  'systemConfig.desc': 'Developer upstreams: route by the agent URL segment, model keys provided by the developer. Memory identity goes through the x-tdai-user-key header. Set the global Proxy upstream in the ⚙ settings dialog, "Proxy Upstream" tab.',
  ...
  'systemConfig.agents.hint': 'One upstream per row, routed by the agent URL segment. Model keys are provided by the developer and passed through; memory injection and billing still apply.',
  ...
  'systemConfig.agents.clientsHint': 'Use your own model-provider key; memory identity goes through the x-tdai-user-key header (the sk-mem key from panel member management).',
  'systemConfig.agents.invalid': 'Fill in each upstream name and URL.',
