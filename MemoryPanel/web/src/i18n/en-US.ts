...
export const enUS = {
  ...
  'systemConfig.proxy.hint': 'Swap the model provider\'s Anthropic/OpenAI-compatible endpoint; saving applies immediately and persists to the override config file.',
