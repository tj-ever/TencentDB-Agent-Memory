...
export const enUS = {
  ...
  'menu.desc.feishu_bots': 'Feishu bots bound to Team / Agent / Task via Tencent Mem',
  ...
  'settings.tab.proxy': 'Proxy Upstream',
  ...
  'channels.title': 'Feishu bots',
  'channels.desc': 'Each bot binds one Agent + Task of the current team. Once started it uses a Feishu long connection; requests go through local claude -p with Tencent Mem headers.',
  'channels.create': 'New bot',
  'channels.createTitle': 'Create Feishu bot',
  'channels.sess': 'Sessions',
  'channels.sess.title': 'Session Manager',
  'channels.sess.loading': 'Loading sessions…',
  'channels.sess.abort': 'Abort current task',
  'channels.sess.aborted': 'Current task aborted',
  'channels.sess.queue': 'Pending queue',
  'channels.sess.queueCount': '{{count}} queued',
  'channels.sess.image': '[image]',
  'channels.sess.lines': '{{count}} lines',
  'channels.sess.images': '{{count}} images',
  'channels.sess.list': 'Sessions',
  'channels.sess.clear': 'Clear',
  'channels.sess.clearConfirm': 'Clear session {{sid}}? (drops its claude context; next message starts fresh)',
  'channels.sess.cleared': 'Session cleared',
  'channels.sess.empty': 'No sessions yet',
  'channels.editTitle': 'Edit Feishu bot',
  'channels.needTeam': 'Select a team in the header first.',
  'channels.bridgeDown': 'MemoryBridge is not running (default http://127.0.0.1:8130). Start it with npm start in MemoryBridge/.',
  'channels.empty': 'No Feishu bots yet',
  'channels.col.name': 'Name',
  'channels.col.status': 'Status',
  'channels.col.binding': 'Agent / Task',
  'channels.col.session': 'Session',
  'channels.col.ops': 'Actions',
  'channels.status.running': 'Running',
  'channels.status.stopped': 'Stopped',
  'channels.status.error': 'Error',
  'channels.session.none': 'Fresh each message',
  'channels.session.user': 'Resume per user',
  'channels.session.chat': 'Resume per chat',
  ...
  'channels.deleteHint': 'The long connection will stop first. This cannot be undone.',
  'channels.confirmStart': 'Start bot "{{name}}"?',
  'channels.confirmStop': 'Stop bot "{{name}}"?',
  'channels.processing': 'Processing…',
  'channels.keepSecret': 'Leave blank to keep the current secret',
  'systemConfig.title': 'Developer Config',
  'systemConfig.desc': 'Configure developer upstreams for the current team: route by the agent URL segment and bind memory. Set the global Proxy upstream in the ⚙ settings dialog, "Proxy Upstream" tab.',
  'systemConfig.currentTeam': 'Current team',
  'systemConfig.proxy.title': 'Proxy Upstream',
    'systemConfig.proxy.hint': 'Swap the model provider\'s Anthropic/OpenAI-compatible endpoint. Save multiple upstreams and use the enable switch (single-select) to pick the active one; saving applies immediately and persists to the override config file.',
  'systemConfig.proxy.exactlyOne': 'Exactly one upstream must be enabled',
  'systemConfig.proxy.profile.enabled': 'Enable',
  'systemConfig.proxy.profile.name': 'Name',
  'systemConfig.proxy.profile.namePlaceholder': 'e.g. Relay A',
  'systemConfig.proxy.profile.userAgent': 'UA Spoof',
  'systemConfig.proxy.profile.op': 'Actions',
  'systemConfig.proxy.profile.delete': 'Delete upstream',
  ...
  'systemConfig.proxy.urlRequired': 'Provider URL is required',
  'systemConfig.proxy.supportsImages': 'Model supports images',
  'systemConfig.proxy.supportsImagesHint': 'ON = model can see images (no strip); OFF = text-only, images are stripped before forwarding.',
  'systemConfig.agents.title': 'Developer upstreams',
  'systemConfig.agents.hint': 'One upstream per row, routed by the agent URL segment, bound to an Agent + Task of the current team. The server auto-provisions a fixed memory account for each bound agent — no manual memory key needed.',
  'systemConfig.agents.noTeam': 'Please select a team in the top-left first.',
  'systemConfig.agents.name': 'agent (URL seg)',
  'systemConfig.agents.url': 'Endpoint URL',
  'systemConfig.agents.modelPlaceholder': 'e.g. ark-code-latest',
  'systemConfig.agents.model': 'Model (optional)',
  'systemConfig.agents.remove': 'Remove',
  'systemConfig.agents.copyCc': 'Copy CC config',
  'systemConfig.agents.add': '+ Add upstream',
  'systemConfig.agents.save': 'Save',
  'systemConfig.agents.clientsHint': 'Use your own model-provider key; memory identity is auto-provisioned for the bound agent server-side (no x-tdai-user-key needed).',
  'systemConfig.agents.invalid': 'Fill in each upstream name and URL, and pick an Agent and a Task from the current team.',
  'systemConfig.agents.bindAgent': 'Memory agent',
  'systemConfig.agents.selectAgent': 'Select agent…',
  'systemConfig.agents.bindTask': 'Memory task',
  'systemConfig.agents.selectTask': 'Select task…',
  'systemConfig.agents.memAccount': 'Memory account',
  'systemConfig.agents.memAccountReady': 'Provisioned (sk-mem)',
  'systemConfig.agents.memAccountAuto': 'Auto-provisions on save',

  'channels.field.name': 'Name',
  'channels.field.workDir': 'Working directory',
  'channels.field.agent': 'Agent',
  'channels.field.task': 'Task',
  'channels.field.session': 'Session mode',
  'channels.field.appId': 'Feishu App ID',
  'channels.field.appSecret': 'Feishu App Secret',
  'channels.field.requireMention': 'Require @ in groups',
  'channels.field.initialText': 'Initial prompt text',
  'channels.field.systemPrompt': 'System prompt',
  'channels.field.systemPromptHint': 'Empty = MemoryBridge default rules',
  'channels.help.name': 'Bot name; injected into the claude system prompt.',
  'channels.help.workDir': "claude's working directory (in-container path, e.g. /app/workspaces/xxx). One dir per bot for file isolation.",
  'channels.help.agent': 'Memory-binding Agent: selects which memory/knowledge base this bot uses (isolation dimension).',
  'channels.help.task': 'Memory-binding Task within that Agent.',
  'channels.help.session': 'Session mode: none = new per message / user = continue per user / chat = continue per chat group.',
  'channels.help.appId': "Feishu app_id. Needs long-connection event subscription im.message.receive_v1 and the bot enabled to send/receive.",
  'channels.help.appSecret': 'Feishu app_secret. Stored in plaintext in bots.json; API masks it as ********. Leave empty to keep the current value when editing.',
